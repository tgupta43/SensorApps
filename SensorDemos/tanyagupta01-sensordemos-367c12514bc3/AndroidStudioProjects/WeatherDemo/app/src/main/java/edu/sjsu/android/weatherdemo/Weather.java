...
public class Weather extends Activity {
    ...
    protected void onResume()
    {
        ...
        {
            sensormanager.registerListener(pressureSensorEventListener,pressureSensor,
                    SensorManager.SENSOR_DELAY_NORMAL);
        }
        else
        {
        ...
        {
            sensormanager.registerListener(tempSensorEventListener,temperatureSensor,
                    SensorManager.SENSOR_DELAY_NORMAL);
        }
        else
        {
            pressureTextView.setText("Thermometer Unavailable");
        }
    }
